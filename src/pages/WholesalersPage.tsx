...
export default function WholesalersPage() {
  ...
  const openEdit = (w: Wholesaler) => { setEditing(w); setForm({ name: w.name, code: w.code, type: w.type, contact_email: w.contact_email, drive_folder_url: w.drive_folder_url, documents: w.documents ?? [], metadata: w.metadata }); setDialogOpen(true) }
